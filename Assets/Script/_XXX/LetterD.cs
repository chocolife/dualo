...
public class LetterD : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, ICanvasRaycastFilter
{
	...
	private Color freeze_color = new Color(0.8f, 0.8f, 0.8f, 1.0f);
	...
	{	
		...
		if (isLocated)
		{
			...
			//GetComponent<CanvasRenderer>().SetColor (new Color(0.8f, 0.8f, 0.8f, 1.0f));
			//this.GetComponent<Image> ().color = freeze_color;

			//Debug.Log(GetComponent<Image>().name);
